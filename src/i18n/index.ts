  ...
  resources: {
    en: {
      translation: {
        ...
        page_description_income: 'Track your monthly and annual income. Add income in any currency and manage your financial inflows.',
        page_description_expense: 'Manage your expenses using the envelope method. Create expense categories and set monthly limits for each.',
        page_description_savings: 'Track your existing savings and see how they contribute to your overall budget picture.',
        page_description_goal: 'Set financial goals and track your progress towards achieving them with monthly payment tracking.',
        page_description_idea: 'Learn how the envelope method works and discover all the features of the budget management application.',
        page_description_report: 'View comprehensive financial reports showing your income, expenses, savings, and goals.',
        page_description_settings: 'Manage your account settings, base currency, and preferences.',
        page_description_dashboard: 'Overview of your budget with summary of income, expenses, savings, and goals.',
        loading: 'Loading...',
        budgeting: 'Budgeting',
        ...
        goal_form_use_savings: 'I will use savings',
        goal_form_select_savings_label: 'Select Savings',
        goal_form_select_saving_label: 'Select Savings',
        goal_form_select_savings_placeholder: 'Select savings to use',
        goal_form_savings_amount_label: 'Amount from Savings',
        goal_form_add_savings: 'Select Another Savings',
        goal_created_date_label: 'Created',
    ...
    ru: {
      translation: {
        ...
        page_description_income: 'Отслеживайте свои ежемесячные и годовые доходы. Добавляйте доходы в любой валюте и управляйте своими финансовыми поступлениями.',
        page_description_expense: 'Управляйте расходами с помощью метода конвертов. Создавайте категории расходов и устанавливайте месячные лимиты для каждой.',
        page_description_savings: 'Отслеживайте свои существующие накопления и смотрите, как они влияют на общую картину бюджета.',
        page_description_goal: 'Устанавливайте финансовые цели и отслеживайте прогресс их достижения с ежемесячным отслеживанием платежей.',
        page_description_idea: 'Узнайте, как работает метод конвертов, и откройте для себя все возможности приложения для управления бюджетом.',
        page_description_report: 'Просматривайте подробные финансовые отчёты с информацией о доходах, расходах, накоплениях и целях.',
        page_description_settings: 'Управляйте настройками аккаунта, базовой валютой и предпочтениями.',
        page_description_dashboard: 'Обзор вашего бюджета со сводкой доходов, расходов, накоплений и целей.',
        loading: 'Загрузка...',
        budgeting: 'бюджет',
        ...
        goal_form_target_date_label: 'Дата достижения',
        goal_form_use_savings: 'Буду использовать накопления',
        goal_form_select_savings_label: 'Выберите накопления',
        goal_form_select_saving_label: 'Выберите накопление',
        goal_form_select_savings_placeholder: 'Выберите накопление для использования',
        goal_form_savings_amount_label: 'Сумма из накоплений',
        goal_form_add_savings: 'Выбрать ещё одно накопление',
        goal_created_date_label: 'Дата создания',
